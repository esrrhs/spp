...
# 功能
* 支持的协议：tcp、udp、可靠udp（TODO）、可靠icmp（TODO）
...
|     代理协议         | 直连     | 通过tcp转发 | 通过tcp转发（加密）  |通过tcp转发（加密压缩）  | 通过rudp转发 | 通过rudp转发（加密压缩）  |
|--------------|----------|------------|------------|------------|------------|------------|
| tcp | 2019 MBytes/sec | 1186 MBytes/sec   | 506 MBytes/sec | 73.4 MBytes/sec    |    |    |
| udp |  |    |     |   |    |    |
